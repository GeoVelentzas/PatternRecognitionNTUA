...
%********************** –…Õ¡ ŸÕ Ã≈ ‘œ’” MFCCs *****************************
[C1,I1] = read_all_speakers(4);             %‚ÎÂÂ read_all_speakers
...
figure('Position',[0 0 scrsz(3) scrsz(4)]); %ÍÈÌÁÛÁ Î·ÈÛÈ˘Ì ÛÂ Ù·ÓÂÈÚ
subplot(4,4,1);
plot(idx1(1:I1(1)));                        %1Á ÂÍˆ˛ÌÁÛÁ
ylim([-1 K+1]);
for i=1:(length(I1)-1)
    subplot(4,4,i+1);
    plot(idx1(I1(i)+1 : I1(i+1)));          %ıÔÎÔÈÂÚ ÂÍˆ˘ÌÁÛÂÈÚ
    ylim([-1 K+1]);
end
%**************************************************************************
...
figure('Position',[0 0 scrsz(3) scrsz(4)]);  
subplot(4,4,1);
%idx1= filter([1 1 1]/3,1,idx1); %ÔÏ·ÎÔÔÈÁÛÁ „È· ÂÏˆ·ÌÈÛÁ „ÂÌÈÍÔÙÂÒÁÚ ÏÔÒˆÁÚ
plot(idx1(1:I1(1))); %1Á ÂÍˆ˛ÌÁÛÁ
ylim([-1 K+1]);
for i=1:(length(I1)-1)
    subplot(4,4,i+1);
...
figure('Position',[0 0 scrsz(3) scrsz(4)]);     %ÍÈÌÁÛÁ Î·ÈÛÈ˘Ì ÛÂ Ù·ÓÂÈÚ
subplot(4,4,1);
plot(idx2(1:I2(1)));                            %1Á ÂÍˆ˛ÌÁÛÁ
ylim([-1 K+1]);
for i=1:(length(I2)-1)
    subplot(4,4,i+1);
    plot(idx2(I2(i)+1 : I2(i+1)));              %ıÔÎÔÈÂÚ ÂÍˆ˘ÌÁÛÂÈÚ
    ylim([-1 K+1]);
end
%**************************************************************************
...
figure('Position',[0 0 scrsz(3) scrsz(4)]);  
subplot(4,4,1);
plot(idx3(1:I3(1)));                            %1Á ÂÍˆ˛ÌÁÛÁ
ylim([-1 K+1]);
for i=1:(length(I3)-1)
    subplot(4,4,i+1);
    plot(idx3(I3(i)+1 : I3(i+1)));              %ıÔÎÔÈÂÚ ÂÍˆ˘ÌÁÛÂÈÚ
    ylim([-1 K+1]);
end
%**************************************************************************
